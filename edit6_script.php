...
if(isset($_POST['submit'])){
    ...
    $id= filter_input(INPUT_POST,"uniq",FILTER_SANITIZE_NUMBER_INT); //$_POST['id'];
    ...
    echo "Such of your marks is exceed maxmum (100) Marks. Please re-write again";
     ...
     $sql=$conn->prepare("UPDATE class6 SET pupil=?,parent=?,surname=?,gender=?,kisw=?,his=?,eng=?,scie=?,geo=?,histry=?,civic=?,updated=? WHERE uniqid=?");
