...
<body>
    ...
    <p>
        <a href="result6.php" id="open_link">OPEN</a>
        
        <a href="edit6.php" id="open_link">EDIT</a>
        
        <a href="result.php" id="open_link">CLASSES</a>
    </p>
<div id="contener">
    <h3 style="text-decoration:underline; color:green; font-size:15px;">FOMU YA KUINGIZIA MATOKEO YA WANAFUNZI WA <br>DARASA LA SITA (STD - VI)</h3>
    <form method="POST" action="class6_script.php">
