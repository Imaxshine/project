...
<html>
    ...
    <body>
        <form method="post" action="edit7_script.php">
        <table>
            <thead>
                <tr>
                    <th>#</th>
...
$sql=mysqli_query($conn,"SELECT * FROM `class7` WHERE uniqid=$id");
while($detail=mysqli_fetch_assoc($sql)){?>
            ...
            <a href="edit7.php" style="background:gold; padding:5px; border-radius:10px; text-decoration:none;">&laquo;Back</a>
        </form>
    </body>
</html>
<?php
