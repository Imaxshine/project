...
<html>
    ...
    <body>
        ...
        <h4><a href="class7.php">Enter more resulties</a></h4>
        
        <h2 style="text-align:center;color:purple;">CLASS VII.</h2>
...
$sql=mysqli_query($conn,"SELECT * FROM `class7` ORDER BY pupil ASC");
            ...
            <tbody>
                <tr>
                    <td><?php echo $i++; ?></td>
                        ...
                        <td>
                            <a href="edit7A.php?id=<?php echo $detail['uniqid']; ?>"><span style="background: blue;
                    ...
                    ?> style="background:peru; color:white; font-family:arial; padding:2px; font-weight:bold;">
                        ...
                        <td>
                            <a href="delete7.php?id=<?php echo $detail['uniqid']; ?>"><span style="background: silver; font-size: 18px; text-decoration: none;
