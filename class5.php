...
<body>
    ...
    <p>
        <a href="result5.php" id="open_link">OPEN</a>
        
        <a href="edit5.php" id="open_link">EDIT</a>
        
        <a href="result.php" id="open_link">CLASSES</a>
    </p>
<div id="contener">
    <h3 style="text-decoration:underline; color:green; font-size:15px;">FOMU YA KUINGIZIA MATOKEO YA WANAFUNZI WA
        <br>DARASA LA TANO (STD - V)</h3>

    <form method="POST" action="class5_script.php">
