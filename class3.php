...
<body>
    ...
    <p>
        <a href="result3.php" id="open_link">OPEN</a>
        
        <a href="edit3.php" id="open_link">EDIT</a>
        
        <a href="result.php" id="open_link">CLASSES</a>
    </p>
<div id="contener">
    <h3 style="text-decoration:underline; color:green; font-size:15px;">FOMU YA KUINGIZIA MATOKEO YA WANAFUNZI WA <br>DARASA LA TATU (STD - III)</h3>
    <form method="POST" action="class3_script.php">
        ...
        <h4>Gender</h4>
        <label for="male"><b style="font-size:18px; font-family:Tahoma; font-weight:bold; color:darkblue;">Male</b></label>
        <input type="radio" name="gender" id="male" value="male" required><br/>
        <label for="female"><b style="font-size:18px; font-family:Tahoma; font-weight:bold; color:green;">Female</b></label>
        ...
        <div id="table">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" name="scie" placeholder="histor..." required>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" name="geo" placeholder="geogr..." required>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        Developing arts<br/>and sports  
                    </td>
                    <td>
                        <input type="number" name="civic" placeholder="dev..." required>
                    </td>
                </tr>
                </tbody>
            </table>
