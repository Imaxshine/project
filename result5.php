    ...
    <body>
        ...
        <div id="head">
            <h3 id="head2">
                ...
                MATOKEO YA WANAFUNZI WA DARASA LA TANO (V).
            </h3>
        </div>
        ...
        <table>
            ...
            <?php
            $no=1;
            $sql=mysqli_query($conn,"SELECT CONCAT(pupil,' - ',parent,' - ',surname) AS `names` ,gender,kisw,his,eng,scie,geo,histry,civic,

(kisw+his+eng+scie+geo+histry+civic) AS `jumla`,
ROUND((kisw+his+eng+scie+geo+histry+civic)/7,0) AS `WASTANI`,
CASE
