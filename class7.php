...
<body>
    ...
    <p>
        <a href="result7.php" id="open_link">OPEN</a>
        
        <a href="edit7.php" id="open_link">EDIT</a>
        
        <a href="result.php" id="open_link">CLASSES</a>
    </p>
<div id="contener">
    <h3 style="text-decoration:underline; color:green; font-size:15px;">FOMU YA KUINGIZIA MATOKEO YA WANAFUNZI WA <br>DARASA LA SABA (STD - VII)</h3>
    <form method="POST" action="class7_script.php">
        ...
        <label for="sur" style="font-size:18px; font-family:Tahoma; font-weight:bold; color:maroon;">SURNAME</label><br/>
        <input type="text" name="surname" id="sur" required><br/>
        ...
        <div id="table">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" name="civic" placeholder="vocat..." required>
                    </td>
                </tr>
                </tbody>
            </table>
